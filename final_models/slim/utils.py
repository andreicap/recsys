...
def similarity_matrix_topK(item_weights, forceSparseOutput=True, k=100, verbose=False, inplace=True):
    """
    ...
    if not sparse_weights:
        ...
        if forceSparseOutput:
            W_sparse = scipy.sparse.csr_matrix(W, shape=(nitems, nitems))
        ...
        W_sparse = scipy.sparse.csc_matrix((data, rows_indices, cols_indptr), shape=(nitems, nitems), dtype=np.float32)
